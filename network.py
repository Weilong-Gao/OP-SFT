...
from SGFormer.sgformer import SGFormer as ViT_seg
from SGFormer.sgformer import sgformer_b
...
class ViT(nn.Module):
    def __init__(self):
        ...
        self.feature_extractor = ViT_seg()
        self.feature_extractor.load_state_dict(torch.load("pre-model.path")['state_dict_ema'])
